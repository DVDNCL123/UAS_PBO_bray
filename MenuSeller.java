...
public class MenuSeller extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(690, 325));
        ...
        updateBT.setFont(new java.awt.Font("Yu Gothic UI", 1, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuSeller.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

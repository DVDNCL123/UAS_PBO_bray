 ...
 * @author ASUS
 */
public class DaftarDriver extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaftarDriver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

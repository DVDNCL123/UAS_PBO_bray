 ...
 * @author ASUS
 */
public class DaftarSeller extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        exit.setFont(new java.awt.Font("Yu Gothic UI", 1, 14)); // NOI18N
        exit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uas/pbo/exi.png"))); // NOI18N
        exit.setText("EXIT");
    ...
    private void simpanBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanBTActionPerformed
        ...
        try (PreparedStatement checkStmt = conn.prepareStatement(checkSQL)) {
            ...
            if (rs.next()) {
                ...
                new MenuSeller().setVisible(true);
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaftarSeller.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
